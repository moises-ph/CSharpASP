    ...
    public class ConexionBD
    {
        ...
        private bool AbrirConexion()
        {
            try
            {
                ...
                strCadenaCnx = "workstation id=dbusersapi.mssql.somee.com;packet size=4096;user id=moisesph_SQLLogin_1;pwd=x3tk9jp2ob;data source=dbusersapi.mssql.somee.com;persist security info=False;initial catalog=dbusersapi";
